    ...
    fluidPage(
     ...
     # navbarPage(title = "ClusterApp", windowTitle = tags$img(src = "inst/app/www/favicon.png", width = 30, height = 30)),
      ...
      tags$div(
        ...
        HTML("This app is developed by <a href='mailto:johanna@maertz.eu'>Johanna Maertz</a>. Any questions, feedback, or ideas to improve it, please feel free to reach out (last updated 06.04.2024).")
      )
    )
  )
}
