                              ...
                              for (i in unique(datapoints$ID)) {
                                ...
                                Clusters_sf <- Join_sf %>%
                                  ...
                                  mutate(ID = i,
                                    ...
                                    difftime(date_max, date_min, units = "mins"))/minute_diff, 0)+1), 2)) %>%
                                ...
                                Clusters_sf <- Clusters_sf %>%
                                  ...
                                  Clusters_sf_before <-
                                    ...
                                    if((sum(c("ID", "ClusID", "sum", "prec_time","inout" , "ratio",
                                       ...
                                       (st_crs(Clusters_sf) == st_crs(Clusters_sf_before))){
                                        ...
                                        #adjust ClusID again: this is the file that will be used later again,
                                        ...
                                        #paste(i, (nrow(Clusters_sf_before) + 1):nrow(Clusters_sf), sep = "_")
                                        ...
                                        Clusters_sf$ClusID[is.na(Clusters_sf$ClusID)] <-
                                          paste(i, (max(ClusID_numbers)+1):(max(ClusID_numbers)+
                                  ...
                                  if (lastClustersFile != "No latest cluster file." & onlyClusters == TRUE) {
                                    ...
                                    if((sum(c("ID", "ClusID", "sum", "prec_time","inout" ,
                                              ...
                                              "center_y","geometry") %in% names(Clusters_sf_before)) ==  16) &
                                       (st_crs(Clusters_sf) == st_crs(Clusters_sf_before))){
                                  ...
                                  if(message == "Column names wrong."){
                                    ...
                                    cluster_list <- list(Clusters_sf = Clusters_sf_combined,
                                                         Join_sf = Join_sf_combined, data_sf_traj = data_sf_traj,
                                                         status = status, settings = settings)
