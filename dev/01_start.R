...
usethis::use_mit_license(name = "Johanna Märtz") # You can set another license here
...
golem::use_favicon("C:/Users/johan/Documents/wolf_icon.png") # path = "path/to/ico". Can be an online file.
